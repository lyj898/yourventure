// Small inline SVG icons (currentColor). Gold accent is applied via CSS where used.
...
export function ExternalIcon({ size = 12, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M15 3h6v6M10 14 21 3M18 13v8H5V5h8" />
    </svg>
  );
}

export function CompassIcon({ size = 22, className }: IconProps) {
  // Login mark — archipelago/wayfinding nod.
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
